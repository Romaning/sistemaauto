...
class ImagenesPerfilVehiculoController extends Controller
{
    ...
    {
        $datosplaca=[];
        $placas = DB::table('imagenes_perfil_vehiculos')
            ->leftJoin('vehiculos', 'imagenes_perfil_vehiculos.placa_id', '=', 'vehiculos.placa_id')
    ...
    {
        $datosimgsperfilvehiculos = DB::table('imagenes_perfil_vehiculos')
            ->leftJoin('vehiculos', 'imagenes_perfil_vehiculos.placa_id', '=', 'vehiculos.placa_id')
            ->select('vehiculos.placa_id', 'imagenes_perfil_vehiculos.archivo_subido', 'imagenes_perfil_vehiculos.nombre_imagen_perfil')
