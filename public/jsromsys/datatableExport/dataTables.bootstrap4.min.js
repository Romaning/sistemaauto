...
!function (t) {
    ...
    return h.extend(!0, o.defaults, {
        ...
        var u, p, t, f = new o.Api(d), m = d.oClasses, b = d.oLanguage.oPaginate, g = d.oLanguage.oAria.paginate || {},
            x = 0, w = function (e, a) {
                var t, s, n, o, r = function (e) {
                    e.preventDefault(), h(e.currentTarget).hasClass("disabled") || f.page() == e.data.action || f.page(e.data.action).draw("page")
                };
                for (t = 0, s = a.length; t < s; t++) if (o = a[t], h.isArray(o)) w(e, o); else {
                    switch (p = u = "", o) {
                        case"ellipsis":
                            u = "&#x2026;", p = "disabled";
                            break;
                    ...
                    u && (n = h("<li>", {
                        ...
                        class: "page-link"
                    }).html(u)).appendTo(e), d.oApi._fnBindAction(n, {action: o}, r), x++)
                }
            };
        try {
