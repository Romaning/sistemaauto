                ...
                <div class="row push">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="asignacion_id">ASIGANCIONES DISPONIBLES PARA DEVOLUCIÓN: <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="fecha_devolucion">FECHA DEVOLUCIÓN: <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="motivo_devolucion">MOTIVO DE DEVOLUCIÓN: <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control js-maxlength"
