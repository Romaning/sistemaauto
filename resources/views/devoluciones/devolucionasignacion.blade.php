            ...
            <form action="{{route('devolucion.store')}}" method="POST" enctype="multipart/form-data"
                ...
                <div class="row push">
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-md-12">
                                <label for="asignacion_id">ASIGANCIONES DISPONIBLES PARA DEVOLUCIÓN: <span
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="fecha_devolucion">FECHA DEVOLUCIÓN: <span
                                            class="text-danger">*</span></label>
                                    <input type="date" class="js-flatpickr form-control bg-white"
                                           id="fecha_devolucion"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           id="identificador_acta_devolucion" pattern="[A-Za-z0-9]+" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="tipo_conductor_chofer">TIPO ASIGNACIÓN: <span class="text-danger">*</span></label>
                                    <select class="js-select2 form-control"
                                            id="tipo_conductor_chofer" name="tipo_conductor_chofer"
                                            style="width: 100%;" data-placeholder="Escoger..." >
                                        <option></option>
