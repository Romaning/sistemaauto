                ...
                <div class="row push">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="asignacion_id">DEVOLUCIÓN: <span
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group justify-content-center">
                                        <label for="fecha_devolucion" class="justify-content-center">FECHA DEVOLUCIÓN: <span
                                                class="text-danger">*</span></label>
                                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="motivo_devolucion">MOTIVO DE DEVOLUCIÓN: <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control"
                    ...
                    <div class="col-lg-4">
                        <div class="row">
                            <div class="col" data-toggle="appear" data-class="animated zoomIn">
                                <label for="" class="text-center"> (ARCHIVO ACTA DEVOLUCIÓN)</label>
                                <div class="block">

                                    <div class="block-content">
                                        <div class="js-gallery img-fluid-100 img-link-zoom-in">
                                            <a href="{{asset('imagenes_store/asignaciones/'.$datosdevoluciones->archivo_acta_devolucion)}}"
                                               class="img-link-zoom-in img-thumb img-lightbox justify-content-center">
                                                <img class="justify-content-center img-link-zoom-in img-fluid"
                                                     src="{{asset('imagenes_store/asignaciones/'.$datosdevoluciones->archivo_acta_devolucion)}}"
                                                     width="100%"
                ...
                <div class="row push">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="fecha_asignacion">FECHA ASIGNACIÓN: <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="js-flatpickr form-control bg-white"
                                           id="fecha_asignacion"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="identificador_memorandum">IDENTIFICADOR MEMORÁNDUM: <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="tipo_conductor_chofer">TIPO ASIGNACIÓN: <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control"
                    ...
                    <div class="col-lg-3">
                        <div class="row">
                            <div class="col" data-toggle="appear" data-class="animated zoomIn">
                                <label for="" class="text-center"> (ARCHIVO MEMORÁNDUM ASIGNACIÓN)</label>
                                <div class="block">
                                    <div class="block-content">
                                        <div class="js-gallery img-fluid-100 img-link-zoom-in">
