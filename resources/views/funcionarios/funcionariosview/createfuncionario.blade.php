                ...
                <div class="row push">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="departamento_id">DEPENDENCIA(): <span class="text-danger">*</span></label>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="tipo_contrato_descripcion">TIPO CONTRATO: <span class="text-danger">*</span> </label>
...
@section('js_script_import')
    ...
    <script>
        ...
        /*por default*/
            var marcador = new mapboxgl.Marker({draggable: false}).setLngLat([-68.160324, -16.510689]).addTo(map);
            document.getElementById('coordenday').value = (-68.160324);
            document.getElementById('coordendax').value = (-16.510689);
