                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           class="form-control btn-success js-maxlength"
                                           name="ci"
                                           id="ci"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control js-maxlength" name="apellidos" id="apellidos"
                                           value="{{$filafuncionario->apellidos}}"
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control js-maxlength" name="numero_licencia" id="numero_licencia"
                                           pattern="[A-Za-z0-9]+"
                                           maxlength="191" data-always-show="true"
                                           data-placement="top"
