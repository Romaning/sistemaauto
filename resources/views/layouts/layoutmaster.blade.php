...
<body class="bady">
{{--<div class="titulo-master">ALGUNO DE LOS CÓDIGOS COMO ESTO ESTARÁN EN TODO LADO (MASTER)</div>--}}
...
<script>
    var exito = $('#alerta_alerta_success').val();
    var danger = $('#alerta_alerta_danger').val();
