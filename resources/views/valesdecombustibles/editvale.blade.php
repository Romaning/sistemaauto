                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label for="numero_vale">NÚMERO VALE DE COMBUSTIBLE <span class="text-danger"></span></label>
                                    <input type="text" class="form-control"
                                           value="{{$datosvales->numero_vale}}"
                                           name="numero_vale" id="numero_vale" placeholder='...'>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <select class="js-select2 form-control btn-success"
                                            id="tipo_combustible" name="tipo_combustible"
                                            style="width: 100%;" data-placeholder="Escoger..." required>
                                        <option></option>
                                        <!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                        @foreach($valesDeCombustibles as $valeDeCombustible)
                                            <option
                                                value="{{$valeDeCombustible->tipo_combustible_id}}"
                                                {{$valeDeCombustible->tipo_combustible_id==$datosvales->tipo_combustible? "selected":""}} >
                                                {{$valeDeCombustible->tipo_combustible_descripcion}}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
