...
@section('content')
    ...
    <div class="block shadow p-2 mb-1 rounded" data-toggle="appear" data-class="animated bounceIn">
        ...
        <div class="block-content block-content-full">
            <form action="{{route('vale.update',$datovale->id)}}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label for="fecha_entrega">NÚMERO VALE DE COMBUSTIBLE <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control bg-white"
                                           id="fecha_entrega"
                                           value="{{$datovale->numero_vale}}"
                                            required>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="js-flatpickr form-control bg-white"
                                           ...
                                           value="{{$datovale->fecha_entrega}}"
                                           data-date-format="Y-m-d" required>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label for="placa_id">PLACA VEHÍCULO: <span class="text-danger">*</span></label>
                                    <select class="js-select2 form-control btn-success"
                                        ...
                                        @foreach($datosvehiculo as $datovehiculo)
                                            <option
                                                value="{{$datovehiculo->placa_id}}" {{$datovehiculo->placa_id ==$datovale->placa_id ? "selected":""}} >
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label for="fecha_entrega">TIPO DE COMBUSTIBLE: <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control bg-white"
                                           id="fecha_entrega"
                                           value="{{$datovale->tipo_combustible_descripcion}}"
                                           required>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label for="fecha_entrega">CANTIDAD: <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control bg-white"
                                           id="fecha_entrega"
                                           value="{{$datovale->cantidad}}"
                                           required>
                                </div>
                            </div>
                        </div>
