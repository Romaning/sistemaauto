    ...
    <div class="block shadow p-2 mb-1 rounded" data-toggle="appear" data-class="animated bounceIn">
        ...
        <div class="block-content">
            ...
            <form action="{{route('docsrenov.update', $datosdocrenov->archivero_id)}}" method="POST"
                ...
                @csrf
                @method('PUT')
                <input type="hidden" name="placa_id" value="{{$datosdocrenov->placa_id}}" id="placa_id_subida_docs_renov_vehicular">
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                                <label for="gestion_var_front">GESTIÓN</label>
                            <input type="text" value="{{$datosdocrenov->gestion}}" name="gestion" class="form-control" required>
                        </div>
                    </div>
