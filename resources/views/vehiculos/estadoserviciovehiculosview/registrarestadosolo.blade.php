        ...
        <form action="{{route('estservvehi.storesolo')}}" method="POST"
            ...
            <div class="row">
                ...
                <div class="col col-md-5">
                    <div class="form-group">
                        <label for="motivo">MOTIVO: </label>
                        <input type="text" name="motivo" class="form-control d-none" value="Inicio de actividades">
                        <input type="text" class="form-control" value="Inicio de actividades" disabled>
                    </div>
                </div>
                @endif
            </div>
