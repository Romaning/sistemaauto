                ...
                <div class="col-md-8 shadow p-2 mb-1 rounded">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col">
                                <label for=numero_documento_importacion">NÚMERO DOCUMENTO DE IMPORTACIÓN: </label>
                                <input type="text" class="form-control"
                            ...
                            <div class="row">
                                <div class="col text-center">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control bg-danger text-white text-center"
                                               value="SERVICIO NO ESPECIFICADO!!!">
                                    </div>
                                </div>
                            </div>
                        @endif
