...
Route::prefix('/clase')->group(function () {
    ...
    Route::post('/store/from', 'ControladorVehiculo\ClaseController@storeJson')->name('clase.store.json');
});
...
Route::prefix('/marca')->group(function () {
    ...
    Route::post('/store/from', 'ControladorVehiculo\MarcaController@storeJson')->name('marca.store.json');
});
...
Route::prefix('/tipo')->group(function () {
    ...
    Route::post('/store/from', 'ControladorVehiculo\TipoController@storeJson')->name('tipo.store.json');
});
...
Route::prefix('/tipocombustible')->group(function () {
    ...
    Route::post('/store/from', 'ControladorVehiculo\TipoCombustibleController@storeJson')->name('tipo_combustible.store.json');
});
...
Route::prefix('/vehiculo')->group(function () {
    ...
    /*#################################################################################################################################*/
    Route::get('/tarjetas/todo', 'ControladorVehiculo\VehiculoController@indexcard')->name('vehiculo.index.card');
});
...
Route::prefix('/seguro')->group(function () {
    ...
    Route::put('/update/{grupo_id}/group', 'ControladorVehiculo\SeguroController@updateGroup')->name('seguro.update.group');
